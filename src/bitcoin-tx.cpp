...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s 1credit-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  1credit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded 1credit transaction") + "\n" +
              "  1credit-tx [options] -create [commands]   " + _("Create hex-encoded 1credit transaction") + "\n" +
              "\n";
