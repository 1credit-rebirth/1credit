...
const char * const BITCOIN_CONF_FILENAME = "1credit.conf";
const char * const BITCOIN_PID_FILENAME = "1credit.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "1Credit";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/1Credit";
#else
    // Unix
    return pathRet / ".1credit";
#endif
#endif
}
