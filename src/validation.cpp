...
#if defined(NDEBUG)
# error "1Credit cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "1Credit Signed Message:\n";
...
void UpdateMempoolForReorg(DisconnectedBlockTransactions &disconnectpool, bool fAddToMempool)
{
    ...
    // AcceptToMemoryPool/addUnchecked all assu4661me that new mempool entries have
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s 1CR additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Subsidy is cut in half every 210,000,000 blocks 
    nSubsidy >>= halvings;
    return nSubsidy;
}
